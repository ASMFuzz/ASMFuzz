...
@@ -40,18 +40,18 @@ bool JavaThread::pd_get_top_frame_for_signal_handler(frame* fr_addr,
...
@@ -69,10 +69,10 @@ bool JavaThread::pd_get_top_frame(frame* fr_addr, void* ucontext, bool isInJava)
       return false;
     }
