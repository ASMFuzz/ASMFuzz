...
+//------------------------------UDivLNode---------------------------------------
 ...
 public:
@@ -116,24 +116,6 @@ class UDivLNode : public Node {
...
@@ -180,7 +162,7 @@ class ModDNode : public Node {
...
+//------------------------------UModINode---------------------------------------
 ...
 public:
@@ -191,7 +173,7 @@ class UModINode : public Node {
   virtual uint ideal_reg() const { return Op_RegI; }
 };
...
+//------------------------------UModLNode---------------------------------------
 ...
 public:
@@ -202,25 +184,7 @@ class UModLNode : public Node {
   virtual uint ideal_reg() const { return Op_RegL; }
 };
...
+//------------------------------DivModNode---------------------------------------
 ...
 protected:
@@ -242,7 +206,7 @@ class DivModNode : public MultiNode {
...
+//------------------------------DivModINode---------------------------------------
 ...
 public:
@@ -255,7 +219,7 @@ class DivModINode : public DivModNode {
...
+//------------------------------DivModLNode---------------------------------------
 ...
 public:
@@ -269,7 +233,7 @@ class DivModLNode : public DivModNode {
 };
...
+//------------------------------UDivModINode---------------------------------------
 ...
 public:
@@ -282,7 +246,7 @@ class UDivModINode : public DivModNode {
...
+//------------------------------UDivModLNode---------------------------------------
 ...
 public:
@@ -295,28 +259,4 @@ class UDivModLNode : public DivModNode {
