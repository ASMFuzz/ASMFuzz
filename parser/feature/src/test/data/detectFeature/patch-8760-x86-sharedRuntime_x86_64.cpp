@@ -1503,6 +1503,22 @@ static void gen_special_dispatch(MacroAssembler* masm,
...
@@ -1525,6 +1541,7 @@ nmethod* SharedRuntime::generate_native_wrapper(MacroAssembler* masm,
                                                 BasicType* in_sig_bt,
                                                 VMRegPair* in_regs,
                                                 BasicType ret_type) {
...
@@ -1556,28 +1573,6 @@ nmethod* SharedRuntime::generate_native_wrapper(MacroAssembler* masm,
