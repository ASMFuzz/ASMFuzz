...
@@ -40,16 +40,15 @@ frame JavaThread::pd_last_frame() {
...
@@ -65,7 +64,7 @@ bool JavaThread::pd_get_top_frame_for_profiling(frame* fr_addr, void* ucontext,
       return false;
     }
...
@@ -109,7 +108,11 @@ bool JavaThread::pd_get_top_frame_for_profiling(frame* fr_addr, void* ucontext,
