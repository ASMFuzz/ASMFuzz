...
@@ -646,8 +646,9 @@ private long transferToDirectly(long position, int icount,
     }
...
@@ -656,7 +657,7 @@ private long transferToTrustedChannel(long position, long count,
                                           WritableByteChannel target)
         throws IOException
     {
...
@@ -781,12 +782,66 @@ public long transferTo(long position, long count,
...
@@ -876,8 +931,10 @@ public long transferFrom(ReadableByteChannel src,
             return 0;
...
@@ -1512,6 +1569,10 @@ private native long map0(FileDescriptor fd, int prot, long position,
