...
@@ -38,18 +38,18 @@ bool JavaThread::pd_get_top_frame_for_signal_handler(frame* fr_addr,
...
@@ -67,10 +67,10 @@ bool JavaThread::pd_get_top_frame(frame* fr_addr, void* ucontext, bool isInJava)
       return false;
     }
