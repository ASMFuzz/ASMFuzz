@@ -56,30 +56,30 @@ typedef LONG SCARDHANDLE; /**< \p hCard returned by SCardConnect() */
...
@@ -92,9 +92,9 @@ extern const SCARD_IO_REQUEST g_rgSCardT0Pci, g_rgSCardT1Pci, g_rgSCardRawPci;
 #pragma pack()
 #endif
...
@@ -104,198 +104,198 @@ extern const SCARD_IO_REQUEST g_rgSCardT0Pci, g_rgSCardT1Pci, g_rgSCardRawPci;
