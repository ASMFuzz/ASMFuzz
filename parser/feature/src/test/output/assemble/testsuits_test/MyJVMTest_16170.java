...
public class MyJVMTest_16170 {

    static int i = 0;

    static String s = "O^aAiCPCZ%";

    static String d = "zfQ<CwDwFf";

    static String k = "'pbJ7n[On|";

    static String v = "$!?xI#w0Al";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_16170().createObjectName(i, s, d, k, v, t, plp, pvp));
    }
}
