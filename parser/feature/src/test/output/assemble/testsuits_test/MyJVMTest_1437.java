...
public class MyJVMTest_1437 {

    static String docflavorParam1 = "r>9LG$`1kz";

    static String docflavorParam2 = ">?|0N#@[@.";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_1437().isDocFlavorSupported(docflavor));
    }
}
