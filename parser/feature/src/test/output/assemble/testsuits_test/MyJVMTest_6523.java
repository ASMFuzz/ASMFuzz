...
public class MyJVMTest_6523 {

    static float[] atParam1 = { 0.6938815f, Float.MAX_VALUE, 0.71156776f, 0f, 0.8739637f, 0f, Float.MIN_VALUE, 0.5714463f, Float.NaN, 0.694949f };
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_6523().getRefType(at));
    }
}
