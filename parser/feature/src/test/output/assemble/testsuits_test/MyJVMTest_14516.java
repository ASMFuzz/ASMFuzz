...
public class MyJVMTest_14516 {

    static Object aeParam1 = -558937022;

    static int aeParam2 = 883;

    static String aeParam3 = "l{'qQx4h;%";
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_14516().actionPerformed(ae);
    }
}
