public class MyJVMTest_7000 {

    static char[] arg_0 = { Character.MAX_VALUE, '0', '0', 't', Character.MIN_VALUE, Character.MIN_VALUE, Character.MAX_VALUE, Character.MAX_VALUE, '2', 'N' };

    static Object arg_1 = -896994194;

    static String arg_2 = ":Wp{O+j4Bp";
    ...
    static boolean var_107 = false;

    long func_1(char[] arg_0, Object arg_1, String arg_2, final int arg_3) {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_7000().func_1(arg_0, arg_1, arg_2, arg_3));
    }
}
