public class MyJVMTest_6103 {

    static int codePoint = 2006468176;

    static String name = "EC@\\ih@EUH";
    ...
    static int digitValue = 2;

    static String numericValue = "_[3y:>ZEjy";

    static boolean mirrored = false;

    static String oldName = "!_{*Qs2Dt7";

    static String comment = "LDA\\E\"HTLn";

    static int upperMap = 769728677;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_6103().isDigitValue());
    }
}
