public class MyJVMTest_113 {
    ...
    static boolean[][] rules = {{true,true,false,true,false,true,true,true,false,false},{true,false,true,false,false,false,false,true,false,true}};
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_113().isExcludedSpacingMark(cp));
    }
}
