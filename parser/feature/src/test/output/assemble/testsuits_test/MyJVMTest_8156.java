...
public class MyJVMTest_8156 {

    static String[] args = { "67Koi&&s0C", "}/ yrGWwM-", "yE/&2CICy`", "eTy$1q`;[/", "GyRT0il~<9", "_UiG))&8k$", "^%;KRp|W Q", "O5_d'lMkTj", "RLS~||6{7w", "&\\Kk[$n_\\T" };
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_8156().run(args, loaders);
    }
}
