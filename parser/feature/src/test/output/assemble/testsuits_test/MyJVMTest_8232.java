...
public class MyJVMTest_8232 {

    static Class category = null;

    static String docflavorParam1 = "((6<YZ+3a/";

    static String docflavorParam2 = "/)H|mgXG*E";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_8232().getSupportedAttributeValues(category, docflavor, attributeset));
    }
}
