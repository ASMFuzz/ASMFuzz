...
public class MyJVMTest_7262 {
    ...
    static String[] paddedBadStrings = {"=O3pYJLKIw","n0sU!ML!?n","t\"<T5{E3;@","9K\\l3&ElM@","C6vUe?@$~A","!x7p7hg+YA","jk8V\\XCGAI","BRZX<w{X\"M","aC~{^ Ff=#","6}CSfN:U,M"};

    static String[] paddedGoodStrings = {"db~LKpokz!",">AITEPV u4","3.XZ)%K.kj","lR=yu,GdI`","rr9J59C9wS","yhiS76\\..}","zwbtM`M:[o","uYK3E^}:7K","|xJS:\\W>{F","&9`G )T31Y"};
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_7262().testStrictness();
    }
}
