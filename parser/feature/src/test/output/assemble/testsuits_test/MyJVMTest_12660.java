...
public class MyJVMTest_12660 {

    static AlgorithmParametersSpi paramParam1 = null;

    static String paramParam2Param1 = "]1~)9+7\"MV";

    static double paramParam2Param2 = Double.MIN_VALUE;

    static String paramParam2Param3 = "/ug]U{RI4;";

    static Provider paramParam2 = new AuthProvider(paramParam2Param1, paramParam2Param2, paramParam2Param3);

    static String paramParam3 = "e<>/V)FT-E";

    static AlgorithmParameters param = new AlgorithmParameters(paramParam1, paramParam2, paramParam3);

    static int genParamParam1 = 405;

    static int genParamParam2 = 956;
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_12660().checkParamStrength(param, genParam);
    }
}
