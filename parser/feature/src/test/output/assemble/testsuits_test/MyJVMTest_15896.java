...
public class MyJVMTest_15896 {

    static int N_REDEFINES = 1000;

    static Class clz = null;

    static boolean doneRedefining = false;

    void premain(String agentArgs, final Instrumentation inst) throws Exception {
