...
public class MyJVMTest_16786 {
    ...
    static String[] paddedBadStrings = {"4xp5j@??gY","k/p>vU!=}:","pYXml`5^~1","OI%y\\Ap8GU","XRU%Sx}V/`","v].<G<n.(~","&RCoYBho7h","q5E)_L}g)1","AZQ`ty,QJ!","61yw:7RT*="};

    static String[] paddedGoodStrings = {"s^1?L5(DM|","(M_.4XaWK(","~o5r8LqqUz","-N};a|]BA\"","'NJ_Zu,#Q(","~'{(bBP3/B","I8y~7/fm9/","7wn5I_u)Nn","8}G ('%=\\w","t%iI!><V#I"};
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_16786().testStrictness();
    }
}
