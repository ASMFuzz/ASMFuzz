...
public class MyJVMTest_9780 {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(Arrays.asList(new MyJVMTest_9780().pow_values(nb)[0]));
        System.out.println(Arrays.asList(new MyJVMTest_9780().pow_values(nb)[1]));
    }
}
