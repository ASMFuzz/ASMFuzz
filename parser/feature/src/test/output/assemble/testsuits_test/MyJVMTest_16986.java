public class MyJVMTest_16986 {
    ...
    static int iFld = -1592782708, iFld2 = 0, iFld3 = 1, iFld4 = 1;

    static long instanceCount = -6940434022634763645L;
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_16986().testWithDiamondComplex();
    }
}
