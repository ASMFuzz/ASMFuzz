...
public class MyJVMTest_14459 {

    static String val = "QXp-AWGQ5:";
    ...
    static String[] paddedBadStrings = {"+:BwM?j<en","yeHdnW&G7s",":ee'TOk<js","87A6<'QcQ.","l'0TWB8Lc[","q]XFe+Krt'","?bh&FB(s?b","'3hfB6T#\\U","mPFWuE@@Y>","6Y_ivat98V"};

    static String[] paddedGoodStrings = {"KL{C+/5OpM","IUclNfs>Ju","4LM?tCZVlr","0Aiob9=l&S","!H`c~tOXHO","5]iBo,\\8>S","yo]&Ff/cB)","8uhg*{i8Lr","Un'\"wuhZtJ","]nE-~^PC%V"};
