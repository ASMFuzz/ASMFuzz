public class MyJVMTest_13042 {

    static String s = "pS3tm,#~^l";

    static int codePoint = 0;

    static String name = "p#}MvwQ^'Z";
    ...
    static String numericValue = "\\gdJDpW\\4o";

    static boolean mirrored = false;

    static String oldName = "`$C5dp0v!X";

    static String comment = "8/=dZP%eZ:";

    static int upperMap = 8;

    static int lowerMap = 5;

    static int titleMap = -1340133230;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_13042().parseUpperMap(s));
    }
}
