public class MyJVMTest_17924 {

    static String s = "5e&HrsZGxm";

    static int codePoint = 7;

    static String name = "5LdI>+T!2S";

    static byte generalCategory = 107;
    ...
    static String numericValue = "9/^e|/{MWD";

    static boolean mirrored = true;

    static String oldName = "6/.%f?'9_g";

    static String comment = "XvC-K;I3C>";

    static int upperMap = 6;
    ...
    String parseNumericValue(String s) throws Exception {
        if (s == null)
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_17924().parseNumericValue(s));
    }
}
