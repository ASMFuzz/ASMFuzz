public class MyJVMTest_363 {

    static int codePoint = 6;

    static String name = ":trkg!*p(p";

    static byte generalCategory = 0;

    static byte bidiCategory = 27;

    static int decimalValue = -2042076213;

    static int digitValue = -1906233275;

    static String numericValue = "81Ir)8Q6~@";

    static boolean mirrored = false;

    static String oldName = "a C7'+r}G3";

    static String comment = "p1HVgo$-nn";

    static int upperMap = 872151714;

    static int lowerMap = 1815549895;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_363().hasLowerMap());
    }
}
