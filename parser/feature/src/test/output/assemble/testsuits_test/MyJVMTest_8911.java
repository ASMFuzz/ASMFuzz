public class MyJVMTest_8911 {
    ...
    static int iFld = 0, iFld2 = 1977581789, iFld3 = 1, iFld4 = 1;

    static long instanceCount = -1138564732582281352L;
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_8911().testNoDiamondDiv();
    }
}
