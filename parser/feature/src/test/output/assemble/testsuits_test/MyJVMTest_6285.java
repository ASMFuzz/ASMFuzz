...
public class MyJVMTest_6285 {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(Arrays.asList(new MyJVMTest_6285().newMatrix(size)[0]));
        System.out.println(Arrays.asList(new MyJVMTest_6285().newMatrix(size)[1]));
    }
}
