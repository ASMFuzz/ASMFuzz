...
public class MyJVMTest_11593 {

    static boolean useDirect = true;

    ByteBuffer gb18030_1(boolean useDirect) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_11593().gb18030_1(useDirect);
    }
}
