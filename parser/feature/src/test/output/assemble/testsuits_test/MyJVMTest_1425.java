public class MyJVMTest_1425 {

    static int codePoint = -1511500135;

    static String name = "Mjcl!Yd.mr";

    static byte generalCategory = -114;

    static byte bidiCategory = 5;

    static int decimalValue = 9;

    static int digitValue = -244204761;

    static String numericValue = "8e*^mgZSIJ";

    static boolean mirrored = true;

    static String oldName = "2P%(lmjePk";

    static String comment = "vueLB<vgZ\"";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_1425().hasTitleMap());
    }
}
