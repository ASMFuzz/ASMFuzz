...
public class MyJVMTest_12550 {

    static boolean[] src = { false, false, true, false, false, true, true, false, false, true };
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_12550().test(src, srcPos, dest, destPos, count);
    }
}
