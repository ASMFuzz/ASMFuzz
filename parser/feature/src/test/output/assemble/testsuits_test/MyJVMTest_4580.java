...
public class MyJVMTest_4580 {

    static String signAlgorithm = "gd`S/Ah=(F";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(Arrays.asList(new MyJVMTest_4580().signUsing(signAlgorithm, privateKey)));
    }
}
