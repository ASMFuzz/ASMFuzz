...
public class MyJVMTest_5294 {

    static String country = "A(sacZp/I~";

    static String currencyCode = "`RZ.au@!y*";
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_5294().testCountryCurrency(country, currencyCode, digits);
    }
}
