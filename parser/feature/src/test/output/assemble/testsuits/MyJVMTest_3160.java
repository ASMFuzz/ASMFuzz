public class MyJVMTest_3160 {

    static String s = "k<}$-uQQ,g";

    static int codePoint = 8;

    static String name = ";Om\"N2`*:C";

    static byte generalCategory = -48;

    static byte bidiCategory = -128;

    static int decimalValue = 9;

    static int digitValue = 3;

    static String numericValue = "as8iE4vI7F";

    static boolean mirrored = false;

    static String oldName = "B$'KIp{ml{";

    static String comment = "at#/tSnTVN";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_3160().parseDigitValue(s));
    }
}
