public class MyJVMTest_15055 {

    static int n = 8;

    static int codePoint = 0;

    static String name = "[qm#vl;xN/";
    ...
    static String numericValue = "$KzS&586pR";

    static boolean mirrored = true;

    static String oldName = "\\I\"Y1/.'&~";

    static String comment = "_SFjB\\{?+d";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_15055().hex4(n));
    }
}
