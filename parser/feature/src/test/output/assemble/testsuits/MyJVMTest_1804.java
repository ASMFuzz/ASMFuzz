public class MyJVMTest_1804 {

    static String s = "z6_]D!K%EC";

    static int codePoint = -24473037;

    static String name = "IZ\"$|WQqHP";

    static byte generalCategory = 0;

    static byte bidiCategory = 127;

    static int decimalValue = 144655717;

    static int digitValue = 0;

    static String numericValue = ";{D}-D(_G0";

    static boolean mirrored = true;

    static String oldName = "f'=1@\"%H9K";

    static String comment = "[~/JT<m\"'v";

    static int upperMap = 7;

    static int lowerMap = -922516245;
    ...
    int parseCombiningClass(String s) throws Exception {
        int combining = -1;
        if (s.length() > 0) {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_1804().parseCombiningClass(s));
    }
}
