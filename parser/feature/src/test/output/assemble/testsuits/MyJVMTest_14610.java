public class MyJVMTest_14610 {

    static String s = "f]?>c_>T>7";

    static int codePoint = 685737258;

    static String name = "n-f~za5}S5";

    static byte generalCategory = 0;

    static byte bidiCategory = 0;

    static int decimalValue = 861328076;

    static int digitValue = 0;

    static String numericValue = "A`sPx;vacp";

    static boolean mirrored = true;

    static String oldName = "bkxYqv)9?F";

    static String comment = "2r2tZnE}D4";

    static int upperMap = -2052641320;

    static int lowerMap = 6;

    static int titleMap = 401763960;
    ...
    String parseName(String s) throws Exception {
        if (s == null)
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_14610().parseName(s));
    }
}
