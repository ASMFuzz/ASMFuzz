public class MyJVMTest_2152 {

    static Object var_18 = 4;

    static long var_19 = 0;

    static double var_20 = 0.23285376780000522;

    static Test6663854_Class_0 var_22 = null;

    static byte var_23 = 110;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_2152().func_0());
    }
}
