public class MyJVMTest_15699 {

    static int codePoint = 2;

    static String name = "}V&yO[!yO7";

    static byte generalCategory = 98;
    ...
    static String numericValue = "3?/q]'.Hsh";

    static boolean mirrored = false;

    static String oldName = "2a/~hJk/bg";

    static String comment = "8k/;/9;(M@";

    static int upperMap = 1;

    static int lowerMap = 0;

    static int titleMap = -16094465;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_15699().hasUpperMap());
    }
}
