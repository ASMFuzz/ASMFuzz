public class MyJVMTest_3712 {

    static int codePoint = 4;

    static String name = "{b4L#9W<- ";

    static byte generalCategory = -128;

    static byte bidiCategory = 0;

    static int decimalValue = -2109236241;

    static int digitValue = 5;

    static String numericValue = "v5r:k=f41J";

    static boolean mirrored = true;

    static String oldName = "dv:!#[v3%v";

    static String comment = "?mJR/@g:ve";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_3712().isDecimalValue());
    }
}
