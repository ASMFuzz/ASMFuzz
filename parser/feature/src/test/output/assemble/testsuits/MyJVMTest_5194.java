public class MyJVMTest_5194 {

    static String s = "RM>)jC)+\\`";

    static int codePoint = 0;

    static String name = "0!2y!2n9<l";
    ...
    static String numericValue = "z0..yuye~y";

    static boolean mirrored = false;

    static String oldName = "MW[6)+vNw-";

    static String comment = "am*qS>$*^2";

    static int upperMap = 3;

    static int lowerMap = 2;

    static int titleMap = 436077419;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_5194().parseName(s));
    }
}
