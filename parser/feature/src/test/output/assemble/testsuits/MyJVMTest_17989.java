public class MyJVMTest_17989 {

    static int codePoint = 3;

    static String name = "7|4A=ZxVPJ";
    ...
    static String numericValue = "yvm-+GK`1^";

    static boolean mirrored = true;

    static String oldName = "oZ&hRk4D!\"";

    static String comment = "0qOmqH+tIE";

    static int upperMap = 0;

    static int lowerMap = 1;

    static int titleMap = -1027870311;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_17989().isNumericValue());
    }
}
