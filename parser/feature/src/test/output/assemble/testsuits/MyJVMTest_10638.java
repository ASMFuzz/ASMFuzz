public class MyJVMTest_10638 {

    static int codePoint = 2;

    static String name = "biTj2OWyMU";

    static byte generalCategory = -128;

    static byte bidiCategory = 0;

    static int decimalValue = -771221651;

    static int digitValue = 509117593;

    static String numericValue = "883!UvKdWr";

    static boolean mirrored = false;

    static String oldName = "])Pjfhr?az";

    static String comment = "YS*3F_8mqn";

    static int upperMap = 6;

    static int lowerMap = 952319040;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_10638().hasTitleMap());
    }
}
