public class MyJVMTest_13053 {

    static String s = "xa[{Gu}#qK";

    static int codePoint = 1;

    static String name = "\\YwubFO2QW";
    ...
    static int digitValue = 8;

    static String numericValue = "rhjGV=u/C\"";

    static boolean mirrored = true;

    static String oldName = "Eh(%?h&&&!";

    static String comment = "\\ua*8Rirtk";

    static int upperMap = -1399677517;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_13053().parseDecimalValue(s));
    }
}
