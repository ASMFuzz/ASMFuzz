...
public class MyJVMTest_2792 {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(Arrays.asList(new MyJVMTest_2792().newMatrix(size)[0]));
        System.out.println(Arrays.asList(new MyJVMTest_2792().newMatrix(size)[1]));
    }
}
