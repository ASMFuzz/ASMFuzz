...
public class MyJVMTest_6688 {
    ...
    static int[] prevCounters = {4,0,0,7,1830884440,0,5,4,2058042091,0};

    static int intervalForCounterCheck = 4;
    ...
    static String str = "<{g3~a-Y>r";

    static int max = -1707801956;
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_6688().checkCounters();
    }
}
