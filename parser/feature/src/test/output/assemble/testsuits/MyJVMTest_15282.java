...
public class MyJVMTest_15282 {
    ...
    static PublicKey selfSignedCertPubKey = null;

    static PublicKey crlIssuerCertPubKey = null;

    void setup() throws CertificateException, CRLException {
