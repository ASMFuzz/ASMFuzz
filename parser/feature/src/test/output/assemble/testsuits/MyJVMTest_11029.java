public class MyJVMTest_11029 {

    static String s = "CRfk1$0/08";

    static int codePoint = 6;

    static String name = "]T(n}w/ju-";

    static byte generalCategory = 0;

    static byte bidiCategory = 8;

    static int decimalValue = 4;

    static int digitValue = 4;

    static String numericValue = "c,t2uSAq/n";

    static boolean mirrored = true;

    static String oldName = "dlMl#oLz0:";

    static String comment = "hw5\\;j~p{8";

    static int upperMap = 785490615;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_11029().parseCombiningClass(s));
    }
}
