...
public class MyJVMTest_14931 {

    static Object aeParam1 = -1990763484;

    static int aeParam2 = 368;

    static String aeParam3 = "g\"Ik*E5(p<";

    static long aeParam4 = -9223372036854775808L;

    static int aeParam5 = 674;
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_14931().actionPerformed(ae);
    }
}
