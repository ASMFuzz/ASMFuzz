...
public class MyJVMTest_5896 {

    static InetAddress ia = null;

    static boolean testSend = false;

    DatagramChannel doTest(InetAddress ia, boolean testSend) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_5896().doTest(ia, testSend);
    }
}
