...
public class MyJVMTest_4584 {

    static byte[] data = { 123, 107, 59, 71, -14, -121, 28, 100, 120, -126 };

    static PublicKey pub = null;

    static PrivateKey priv = null;

    static String digestAlg = "ZC^DltTAg5";
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_4584().checkSignature(data, pub, priv, digestAlg, keySize);
    }
}
