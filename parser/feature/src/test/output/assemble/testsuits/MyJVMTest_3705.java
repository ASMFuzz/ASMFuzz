public class MyJVMTest_3705 {

    static String s = "q`tZb\\D[Y&";

    static int codePoint = 0;

    static String name = "/Mvm<UlRcW";
    ...
    static int digitValue = -272595835;

    static String numericValue = "(lh/b^0,M:";

    static boolean mirrored = false;

    static String oldName = "G`5uqc#:/0";

    static String comment = "6!;:MUQVJ/";
    ...
    int parseUpperMap(String s) throws NumberFormatException {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_3705().parseUpperMap(s));
    }
}
