public class MyJVMTest_3678 {

    static double val1 = Double.POSITIVE_INFINITY;

    static double val2 = Double.NaN;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_3678().compare(val1, val2, maxulps));
    }
}
