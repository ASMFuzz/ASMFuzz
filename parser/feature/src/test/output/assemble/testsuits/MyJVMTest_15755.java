public class MyJVMTest_15755 {

    static double d1 = 0d;

    static Integer i1 = 655747222;

    static long l1 = -9223372036854775808L;
    ...
    static float f4 = Float.POSITIVE_INFINITY;

    static float f5 = Float.MIN_VALUE;

    static float f6 = Float.NaN;

    static float f7 = 0.07385892f;

    static float f8 = Float.MAX_VALUE;

    static float f9 = Float.NaN;

    static float f10 = Float.NaN;

    static float f11 = Float.MAX_VALUE;

    static float f12 = 0.67829144f;

    static float f13 = Float.MIN_VALUE;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_15755().testMethod(d1, i1, l1, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13));
    }
}
