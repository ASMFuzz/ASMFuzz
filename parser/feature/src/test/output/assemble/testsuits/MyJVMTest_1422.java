...
public class MyJVMTest_1422 {

    static byte bits = -128;

    static int rate = 6;

    static int channel = -220762924;

    static long frameLength = -9223372036854775808L;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(Arrays.asList(new MyJVMTest_1422().createHeader(bits, rate, channel, frameLength)));
    }
}
