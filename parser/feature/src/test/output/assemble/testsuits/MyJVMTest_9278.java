public class MyJVMTest_9278 {

    static String s = "Lo\\K8Q_[,@";

    static int codePoint = 0;

    static String name = "5[k~z@9Qh$";

    static byte generalCategory = -128;

    static byte bidiCategory = 127;

    static int decimalValue = -140518761;

    static int digitValue = 1698140758;

    static String numericValue = "ox)\\)m5%nO";

    static boolean mirrored = false;

    static String oldName = "w8*+`dhHef";

    static String comment = "co>HDDyPj8";

    static int upperMap = 0;

    static int lowerMap = -1189066927;
    ...
    int parseTitleMap(String s) throws NumberFormatException {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_9278().parseTitleMap(s));
    }
}
