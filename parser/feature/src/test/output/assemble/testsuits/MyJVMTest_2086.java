...
public class MyJVMTest_2086 {

    static String specParam1 = "+cS [8%Dny";

    static String specParam2 = "U[mT]&up=`";

    static AlgorithmParameterSpec specParam3 = null;

    static int specParam4 = 334;

    static int specParam5 = 0;
