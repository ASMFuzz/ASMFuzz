...
public class MyJVMTest_1851 {

    static String toplevelParam1Param1Param1 = "CE-Rj$Sq\"x";
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_1851().setToplevelLocation(toplevel, component, relativePosition);
    }
}
