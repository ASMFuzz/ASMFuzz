public class MyJVMTest_12815 {
    ...
    void test_rolv_vec(int[] a0, int[] a1, int[] a2) {
        for (int i = 0; i < a0.length; i += 1) {
            a0[i] = (int) (Integer.rotateLeft(a1[i], a2[i]));
        }
    }

    void test_rorv_vec(int[] a0, int[] a1, int[] a2) {
        for (int i = 0; i < a0.length; i += 1) {
