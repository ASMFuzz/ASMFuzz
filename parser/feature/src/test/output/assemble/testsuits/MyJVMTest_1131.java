...
public class MyJVMTest_1131 {

    static byte[] encoded = { -119, 53, 39, -56, -64, 82, -113, 35, -94, -17 };

    static CoderResult expected = null;

    static String label = "H*<cF>jt:I";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_1131().decodeResultTest(encoded, expected, label));
    }
}
