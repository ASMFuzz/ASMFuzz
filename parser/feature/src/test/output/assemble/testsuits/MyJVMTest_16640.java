public class MyJVMTest_16640 {

    static String s = "''R=.fKf^v";

    static int codePoint = 0;

    static String name = "D!=_jk@xQT";

    static byte generalCategory = -85;

    static byte bidiCategory = 0;

    static int decimalValue = -939419796;

    static int digitValue = 8;

    static String numericValue = "=zEadB3%S;";

    static boolean mirrored = false;

    static String oldName = "CM-GDJAYxn";

    static String comment = "Y'EnN=1jtY";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_16640().parseComment(s));
    }
}
