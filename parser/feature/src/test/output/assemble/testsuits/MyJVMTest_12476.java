public class MyJVMTest_12476 {

    static String s = "-\"_6eyZ1f-";

    static int codePoint = 349985246;

    static String name = "-06b<@bpn%";

    static byte generalCategory = 0;

    static byte bidiCategory = 63;

    static int decimalValue = 1533911475;

    static int digitValue = -13277282;

    static String numericValue = "{gDW~X@jMW";

    static boolean mirrored = true;

    static String oldName = "opdrC;'ntr";

    static String comment = "fzAIU}5(K8";

    static int upperMap = 4;

    static int lowerMap = 4;

    static int titleMap = -1207843908;
    ...
    int parseDigitValue(String s) throws NumberFormatException {
        int value = -1;
        if (s.length() > 0) {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_12476().parseDigitValue(s));
    }
}
