public class MyJVMTest_8405 {

    static int codePoint = 565838153;

    static String name = "qBoQkF.\"Yc";
    ...
    static int digitValue = 1019112966;

    static String numericValue = "wGHH'/Jp>E";

    static boolean mirrored = true;

    static String oldName = "#xf>LPtbY1";

    static String comment = "6o`TF_@b;U";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_8405().isNumericValue());
    }
}
