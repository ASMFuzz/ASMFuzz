...
public class MyJVMTest_13175 {

    static int i = 0;

    static Class c = null;

    static String s = "mWhI'A*lHK";

    static String d = "eMhY-9y~7K";

    static String k = " el}3)nZpD";

    static String v = "&tz^KlX~l@";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_13175().createObjectName(i, c, s, d, k, v, t));
    }
}
