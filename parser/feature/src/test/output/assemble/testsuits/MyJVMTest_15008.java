...
public class MyJVMTest_15008 {
    ...
    static String onParam1 = "E|a^Z$dju ";

    static String onParam2 = "6=W;d-sXeq";

    static String onParam3 = "mlFL*0jgp=";
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_15008().checkNullElement(mbean, proxy, mbs, on);
    }
}
