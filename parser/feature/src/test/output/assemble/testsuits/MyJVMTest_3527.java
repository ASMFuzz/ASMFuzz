public class MyJVMTest_3527 {

    static int n = -1258895859;

    static int codePoint = 0;

    static String name = "( rFZqJ~*u";

    static byte generalCategory = 0;

    static byte bidiCategory = -74;

    static int decimalValue = 0;

    static int digitValue = 0;

    static String numericValue = "%ckuT)O*D|";

    static boolean mirrored = true;

    static String oldName = "('G]!|RUU$";

    static String comment = "YE-wDbDVge";

    static int upperMap = 7;

    static int lowerMap = -679616563;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_3527().hex6(n));
    }
}
