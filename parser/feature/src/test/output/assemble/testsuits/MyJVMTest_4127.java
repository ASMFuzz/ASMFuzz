...
public class MyJVMTest_4127 {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(Arrays.asList(new MyJVMTest_4127().newIntegerMatrix(size)[0]));
        System.out.println(Arrays.asList(new MyJVMTest_4127().newIntegerMatrix(size)[1]));
    }
}
