...
public class MyJVMTest_14705 {

    static Graphics2D g2d = null;

    static String fontParam1 = "r6&@h)l]6K";

    static int fontParam2 = 734;

    static int fontParam3 = 251;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_14705().drawText(g2d, font, ypos));
    }
}
