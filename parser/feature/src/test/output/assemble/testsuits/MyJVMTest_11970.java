public class MyJVMTest_11970 {

    static short arg_0 = 0;

    static byte var_1 = 127;

    static double var_2 = 0d;

    static String var_3 = "IRO`:hu4d4";

    static char var_4 = 'n';

    static int var_5 = 6;

    static String var_6 = "jb`0FYj0mO";

    static long var_7 = 4161100809902398464L;

    static String var_8 = "a";

    char func_4(short arg_0) {
        {
            var_6 = (var_3 = "hjtjar");
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_11970().func_4(arg_0));
    }
}
