public class MyJVMTest_766 {

    static double[] p = { Double.NaN, Double.POSITIVE_INFINITY, Double.NaN, 0d, Double.MIN_VALUE, Double.MIN_VALUE, Double.NEGATIVE_INFINITY, Double.POSITIVE_INFINITY, Double.NaN, Double.POSITIVE_INFINITY };

    static double[] re_root = { 0d, Double.POSITIVE_INFINITY, Double.MAX_VALUE, Double.NaN, Double.NaN, 0d, Double.MIN_VALUE, 0.2966458198244879, 0d, 0d };

    static double[] im_root = { Double.NEGATIVE_INFINITY, Double.MAX_VALUE, Double.MAX_VALUE, Double.NEGATIVE_INFINITY, 0d, Double.MAX_VALUE, Double.POSITIVE_INFINITY, Double.POSITIVE_INFINITY, Double.MAX_VALUE, 0d };
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_766().root3(p, re_root, im_root));
    }
}
