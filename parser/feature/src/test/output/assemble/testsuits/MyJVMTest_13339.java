...
public class MyJVMTest_13339 {

    static float width = Float.POSITIVE_INFINITY;

    static boolean useDashes = true;

    static float dashMinLen = Float.MAX_VALUE;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_13339().createStroke(width, useDashes, dashMinLen));
    }
}
