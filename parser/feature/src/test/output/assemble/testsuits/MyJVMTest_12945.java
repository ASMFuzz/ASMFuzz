...
public class MyJVMTest_12945 {

    static int[] type = { 0, 6, 3, 0, 0, 0, 6, 6, 5, 0 };
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(Arrays.asList(new MyJVMTest_12945().createHeader(type, rate, channel, size)));
    }
}
