...
public class MyJVMTest_9701 {
    ...
    static String[] paddedBadStrings = {"PXz=EtOH}A","Ru$uG4F\\Xa","$ew0=_nL[>","XkHoIz$6dc","PhcWOwOmM5","_c:~1aw~ED","0\\CeLYZF_1",":U,w-3~_$0","4vk.\"q94P[","(!\"a]XWHb "};

    static String[] paddedGoodStrings = {"Ox/';$*ib{","d17Pff <7N","d!3\"R!^{-n","Afs}VaxT`Q","?8ub/ayk.&","u?(@L~*dK}",".4(Wn\\>9l3","+U?BH)4LId","`W0YgiD##?","[mHe&,672["};

    void testSubnormalPowers() {
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_9701().testSubnormalPowers();
    }
}
