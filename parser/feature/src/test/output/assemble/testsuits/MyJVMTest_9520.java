public class MyJVMTest_9520 {

    static int codePoint = 1884859009;

    static String name = "WE2H>hRD.'";
    ...
    static String numericValue = "F_0d{vO:9_";

    static boolean mirrored = true;

    static String oldName = "\"g/I;VZ)+(";

    static String comment = "E;A?f+?K[X";

    static int upperMap = 0;

    static int lowerMap = 3;

    static int titleMap = 749203602;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_9520().hasLowerMap());
    }
}
