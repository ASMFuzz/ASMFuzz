public class MyJVMTest_10044 {

    static int codePoint = 1527390982;

    static String category = "Paqg4|*G}9";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_10044().isIdentifierIgnorable(codePoint, category));
    }
}
