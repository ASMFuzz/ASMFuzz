public class MyJVMTest_6226 {

    static int codePoint = 0;

    static String name = "g+|tV\\ n})";
    ...
    static String numericValue = "~HHo$$oXFc";

    static boolean mirrored = false;

    static String oldName = "hw9m=r\"~*^";

    static String comment = "$3Fh19'9Og";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_6226().hasUpperMap());
    }
}
