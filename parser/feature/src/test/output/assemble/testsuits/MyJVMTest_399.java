...
public class MyJVMTest_399 {

    static GraphicsConfiguration testframeParam1 = null;

    static Frame testframe = new Frame(testframeParam1);

    static String msg = "op8H:NK,)G";
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_399().setVisibleAndConfirm(testframe, msg);
    }
}
