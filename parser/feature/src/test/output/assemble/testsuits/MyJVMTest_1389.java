...
public class MyJVMTest_1389 {

    static List<Rdn> name1Param1 = new ArrayList<Rdn>();
    ...
    static int expectedResult = 1440140491;
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_1389().checkResults(name1, name2, expectedResult);
    }
}
