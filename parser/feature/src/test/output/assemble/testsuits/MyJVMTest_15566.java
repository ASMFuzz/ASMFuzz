public class MyJVMTest_15566 {

    static int codePoint = -1143310329;

    static String name = " u'n[f=Z[O";

    static byte generalCategory = -57;

    static byte bidiCategory = 127;

    static int decimalValue = 0;

    static int digitValue = 1036335903;

    static String numericValue = "lWnch:%C#Z";

    static boolean mirrored = true;

    static String oldName = "H;S:\\\"I{fF";

    static String comment = "x?DY*sj0Kz";

    static int upperMap = -1236844911;

    static int lowerMap = 1;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_15566().isDigitValue());
    }
}
