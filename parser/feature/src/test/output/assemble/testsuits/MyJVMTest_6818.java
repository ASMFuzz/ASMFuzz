public class MyJVMTest_6818 {
    ...
    static int iFld = 964964788, iFld2 = 2, iFld3 = 1, iFld4 = 1;

    static long instanceCount = 1952104811925711161L;
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_6818().testWithDiamond();
    }
}
