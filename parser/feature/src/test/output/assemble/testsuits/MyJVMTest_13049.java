public class MyJVMTest_13049 {

    static int codePoint = -26572485;

    static String name = "z?t\"gL1m>*";

    static byte generalCategory = 73;

    static byte bidiCategory = -128;

    static int decimalValue = 0;

    static int digitValue = 895423386;

    static String numericValue = "4*[Z;m/r6P";

    static boolean mirrored = false;

    static String oldName = "JkFs\\1>UTX";

    static String comment = "r%d;J\"\\AV4";

    static int upperMap = 9;

    static int lowerMap = 599063854;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_13049().isDecimalValue());
    }
}
