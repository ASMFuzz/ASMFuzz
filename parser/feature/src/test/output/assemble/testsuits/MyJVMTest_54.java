public class MyJVMTest_54 {

    static String s = "HvacYd!&.Z";

    static int codePoint = 8;

    static String name = "Sv{O08QV_C";

    static byte generalCategory = -128;

    static byte bidiCategory = 77;

    static int decimalValue = 9;

    static int digitValue = 1;

    static String numericValue = "<.'>nl>UUa";

    static boolean mirrored = false;

    static String oldName = "mGe)V`DK\\<";

    static String comment = "Kwc8X@L*cR";

    static int upperMap = 2001853013;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_54().parseCodePoint(s));
    }
}
