public class MyJVMTest_13342 {

    static String s = "M['0Y-^M&6";

    static int codePoint = -179767434;

    static String name = "?0KZXCJr_u";

    static byte generalCategory = 127;

    static byte bidiCategory = -113;

    static int decimalValue = 8;

    static int digitValue = -653710809;

    static String numericValue = "xR,#pzqg{V";

    static boolean mirrored = false;

    static String oldName = "\"4w$u5H8kG";

    static String comment = "_QB!%M+K#S";

    static int upperMap = 0;

    static int lowerMap = 7;

    static int titleMap = -150709567;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_13342().parseOldName(s));
    }
}
