...
public class MyJVMTest_12928 {

    static String crypt = "cu@'G9bXF1";

    static String mode = "=_QP+&dzXq";

    static String padding = "5AM4qCeE%m";
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_12928().init(crypt, mode, padding);
    }
}
