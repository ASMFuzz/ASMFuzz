...
public class MyJVMTest_4807 {

    static String parent = "h'h({Pg3L ";

    static String child = "0UK+bRPtJB";

    static String patterninfo = "qJK&l#&+5V";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_4807().Test(parent, child, patterninfo));
    }
}
