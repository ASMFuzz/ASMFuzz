...
public class MyJVMTest_1160 {

    static SecureRandomSpi srParam1 = null;

    static String srParam2Param1 = "hTT:3jFSM)";

    static double srParam2Param2 = Double.NEGATIVE_INFINITY;

    static String srParam2Param3 = "/[~l\\u-\"X\\";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_1160().forEachSeedBytes(sr));
    }
}
