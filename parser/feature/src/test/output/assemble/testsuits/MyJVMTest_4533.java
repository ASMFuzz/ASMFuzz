...
public class MyJVMTest_4533 {

    static int keySize = -1571881693;

    static boolean[] testStatus = { true, true, true, true, false, false, true, true, true, false };
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_4533().test(keySize, testStatus);
    }
}
