...
public class MyJVMTest_16650 {

    static int runCount = 0;

    static String text = "7__LVV|LA^";

    static String levels = "t ofgGXn2;";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(Arrays.asList(new MyJVMTest_16650().getObjects(runCount, text, levels)));
    }
}
