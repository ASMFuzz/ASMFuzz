...
public class MyJVMTest_537 {
    ...
    static String[] paddedBadStrings = {"\\sdc{@{#CQ","_kq0zJX1I6",";zMCB77)^[","E]@#M4,nZS","wM^Jcs(d:\"","O^5hZk6>%{","^}3.rP#f -","e\\2\".}[K-O","-W[W`y0m~S","~U>hy'rN'."};

    static String[] paddedGoodStrings = {"\"x=6meaT<}","qQ!vVPXem?","Dt&YSzfu,#","+8itg.:m@{","Gwa9QCC2;%","@DJ\\%KBRdr","%\"7>p@U_zu","p3,Zr0H3v#","w>_U\\VAMD2"," _}nzW,r_+"};
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_537().testSubnormalPowers();
    }
}
