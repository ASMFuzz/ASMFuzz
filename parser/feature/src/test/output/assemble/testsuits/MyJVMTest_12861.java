public class MyJVMTest_12861 {

    static int n = 1;

    static int codePoint = -1255196663;

    static String name = "Fzpz'$G/89";

    static byte generalCategory = 127;

    static byte bidiCategory = 127;

    static int decimalValue = 3;

    static int digitValue = 3;

    static String numericValue = "=}JQ65~KD*";

    static boolean mirrored = false;

    static String oldName = "6S(;%<L32J";

    static String comment = "|~A2_!*V;w";

    static int upperMap = 7;

    static int lowerMap = -845885930;

    static int titleMap = 915058942;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_12861().hex6(n));
    }
}
