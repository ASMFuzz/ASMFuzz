public class MyJVMTest_9196 {

    static String s = "md>MBz~U;u";

    static int codePoint = 8;

    static String name = "50PTf_UNIM";

    static byte generalCategory = 0;

    static byte bidiCategory = 43;

    static int decimalValue = 0;

    static int digitValue = 0;

    static String numericValue = ")fb#LkG\"F~";

    static boolean mirrored = false;

    static String oldName = "V)R1/I#YMt";

    static String comment = "6K,T,fX8+S";

    static int upperMap = 1333447952;

    static int lowerMap = 9;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_9196().parseCodePoint(s));
    }
}
