...
public class MyJVMTest_9814 {

    static String val = "OJ.@p55=J-";
    ...
    static String[] paddedBadStrings = {"EI/H\"$NSr5","u;vX>20aV|","Py2-*Lw!ZB","K1I7G:Lm@h","155,=~FiwU","k^.(%iE)eZ","86Th1K!Ukn","cr18&+R^Lg","g{W}B7{>B\"","J'#NdC3;Bz"};

    static String[] paddedGoodStrings = {"_vF$G7`I;1","Om4Lq|zkn ","9{pxSK\"r.q","woTOid7<Ho","\\/6mDV+V$b","b\\VJs\"knSi","fi[J}fw59u","(T.cfJa;1o","5#c=pT%CR!","};y_+k,p@m"};
