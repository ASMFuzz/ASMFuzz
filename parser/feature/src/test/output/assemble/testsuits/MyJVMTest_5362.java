public class MyJVMTest_5362 {

    static String value = "bzq\"&-5;kT";

    static String allowedchars = "lB0^8%}k>c";

    static String notallowedchars = "tMH>IxN\\(>";

    static String logmsg = "xKnm#>oQrm";
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_5362().checkArgumentSyntax(value, allowedchars, notallowedchars, logmsg));
    }
}
