public class MyJVMTest_6050 {

    static String s = "(<g7 Av|5m";

    static int codePoint = 4;

    static String name = "\"aH{XURam^";
    ...
    static String numericValue = "1z5M2\"1~bY";

    static boolean mirrored = true;

    static String oldName = "}vwU0]=W16";

    static String comment = "&4=B]7J=%M";

    static int upperMap = -1666214962;

    static int lowerMap = 1949299411;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_6050().parseLowerMap(s));
    }
}
