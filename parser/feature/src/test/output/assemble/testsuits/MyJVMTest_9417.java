public class MyJVMTest_9417 {

    static String s = "||F\\G,34UY";

    static int codePoint = 0;

    static String name = "#CBk9V/U$4";
    ...
    static String numericValue = "bjkSt{c*mr";

    static boolean mirrored = true;

    static String oldName = "@q_i~8oG4&";

    static String comment = "Ww`gY$G/#=";

    static int upperMap = 0;

    static int lowerMap = -1886383951;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_9417().parseMirrored(s));
    }
}
