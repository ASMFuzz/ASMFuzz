public class MyJVMTest_3909 {

    static String s = "Gtee*PgZ\"+";

    static int codePoint = 0;

    static String name = "]a`u_L_1Y!";

    static byte generalCategory = 0;

    static byte bidiCategory = 100;

    static String decomposition = "v!d0;UVW{g";

    static int decimalValue = 6;

    static int digitValue = -503494439;

    static String numericValue = "3{y8wBp8lf";

    static boolean mirrored = true;

    static String oldName = ";2:mz\\+N[R";

    static String comment = "O#'[>D Y,x";

    static int upperMap = 1;

    static int lowerMap = 8;

    static int titleMap = 7;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_3909().parseDecomposition(s));
    }
}
