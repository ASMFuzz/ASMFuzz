public class MyJVMTest_131 {
    ...
    static String s = "3qg%L/_,HD";

    static int codePoint = 5;

    static String name = "u^qJ1kG}RE";
    ...
    static String numericValue = "=:c([K>s A";

    static boolean mirrored = true;

    static String oldName = "LI6To'ze|B";

    static String comment = "f-1Rr1#'Mb";

    static int upperMap = 3;

    static int lowerMap = 2077316249;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_131().parseTitleMap(s));
    }
}
