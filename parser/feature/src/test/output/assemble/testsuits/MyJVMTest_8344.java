public class MyJVMTest_8344 {

    static String s = "\"DRIY:'<jr";

    static int codePoint = 0;

    static String name = "Z73qeJ2*Ir";
    ...
    static String numericValue = "g{N,}Mw'F@";

    static boolean mirrored = false;

    static String oldName = "@Je=zl<~;G";

    static String comment = "C .Yx>1 s\"";

    static int upperMap = -1147690155;

    static int lowerMap = 0;

    static int titleMap = 3;
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_8344().parseNumericValue(s));
    }
}
