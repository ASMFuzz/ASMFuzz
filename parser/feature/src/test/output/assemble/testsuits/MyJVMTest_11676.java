...
public class MyJVMTest_11676 {

    static String specParam1 = "JQ4(n\"p4/l";

    static String specParam2 = "pn*{y8=%W+";

    static AlgorithmParameterSpec specParam3 = null;

    static int specParam4 = 109;

    static int specParam5 = 811;
