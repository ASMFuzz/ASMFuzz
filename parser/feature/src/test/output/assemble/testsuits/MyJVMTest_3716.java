public class MyJVMTest_3716 {

    static String s = "s{m8y'ouM.";

    static int codePoint = 715622715;

    static String name = "%R?}oPQ8f!";

    static byte generalCategory = 51;

    static byte bidiCategory = 0;

    static int decimalValue = 1596867445;

    static int digitValue = 1302378541;

    static String numericValue = "u7^#5IHYcY";

    static boolean mirrored = false;

    static String oldName = "9AY!/2,@D'";

    static String comment = ";xa`QKwg1U";

    static int upperMap = 2;

    static int lowerMap = 0;

    static int titleMap = 2;
    ...
    int parseDecimalValue(String s) throws NumberFormatException {
        int value = -1;
        if (s.length() > 0) {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(new MyJVMTest_3716().parseDecimalValue(s));
    }
}
