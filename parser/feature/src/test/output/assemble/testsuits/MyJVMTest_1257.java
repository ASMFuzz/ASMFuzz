...
public class MyJVMTest_1257 {

    static String signAlgorithm = "}liSUF},Ke";

    static PublicKey publicKey = null;

    static byte[] signature = { 7, -21, 31, -124, -18, -16, 32, 39, 78, 51 };
    ...
    public static void main(String[] args) throws Exception {
        new MyJVMTest_1257().verifyUsing(signAlgorithm, publicKey, signature);
    }
}
