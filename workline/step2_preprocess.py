...
class AddExports():
    ...
    def delete_file(self):
        if os.path.exists(self.exportdir):
            ...
            print(f"{self.exportdir} init")
        else:
            print(f"{self.exportdir} over")
...
def run_addExports_main():
    ...
    export_dir = "/root/asmfuzz/workline/data/addExports.txt"
...
def run_energyupdate_main():
    ...
    obj.val_dir = "/root/asmfuzz/feature/src/test/output/target_test"
    obj.Mutation_method = 1
    all_files = obj.read_mutators_fromDir()

    mutator_file = "/root/asmfuzz/feature/src/test/output/target_test/0/MyJVMTest_201363.txt"
...
def run_compareCoverage_main():
    ...
    test1f="/root/asmfuzz/fuzz/data/entropyData/analyse1.txt"
    test2f="/root/asmfuzz/fuzz/data/entropyData/analyse2.txt"
    prefix = "/root/asmfuzz/fuzz/data/entropyData/HTMLFileJT3"
...
if __name__=='__main__':
    basePath = "/root/asmfuzz/parser/feature/src/test/output/task003/"
    max_number = find_max_folder_number(basePath)
    dir = '/root/asmfuzz/parser/feature/src/test/output/task003/folder_{}/seedTemp_testsuits'.format(max_number)
    run_testcaseToDB_main(dir)
    source_folder = "/".join(dir.split("/")[:-1])
    destination_folder = "/root/asmfuzz/parser/feature/src/test/output/task001"
