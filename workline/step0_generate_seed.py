...
def get_args(prompt="import java",
    ...
    parser.add_argument(
        "--model_name_or_path",
        default="/root/asmfuzz/seedData/trained_model/checkpoint-400000",
        type=str,
        required=False,
...
def saveAndgenerate():
    try:
        ...
        jpype.startJVM(jvmPath, classpath=["/root/asmfuzz/parser/generate_tools/SaveIntoDatabase/target/SaveIntoDatabase-1.0-SNAPSHOT-shaded.jar",
                                           "/root/asmfuzz/parser/generate_tools/GenerateTestcases/target/generator_new-1.0-SNAPSHOT-shaded.jar"])
...
if __name__ == "__main__":
    ...
    saveAndgenerate()
    grammar_path = "/root/asmfuzz/parser/generate_tools/GrammaCheck/target/GrammaCheck-1.0-SNAPSHOT-shaded.jar"
    stdout, stderr = run_jar(grammar_path)
    print("The correctly processed seeds have been transferred to---->/root/asmfuzz/seedData/pass_data")
