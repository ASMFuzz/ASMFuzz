...
lcov_cmd="lcov -d /root/jvm/openjdk11/jdk-11.0.14-ga/build/linux-x86_64-normal-server-release/hotspot/variant-server/libjvm/objs --rc lcov_branch_coverage=1 --gcov-tool /usr/bin/gcov - -o /root/shannonfuzz-python/fuzz/coverage/mm${NUM}/output${NUM}group${INDEX}.info"
