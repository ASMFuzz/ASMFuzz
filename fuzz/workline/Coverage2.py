...
class Coverage3:
    def __init__(self):
        self.listTestcase = []
        self.want_testbed_location = "/root/jvm/openjdk11/jdk11.14.2/jdk-11.0.14-ga/build/linux-x86_64-normal-server-release/images/jdk/bin/java"
